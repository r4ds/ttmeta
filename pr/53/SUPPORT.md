...
Thanks for using ttmeta! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/r4ds/ttmeta/issues/new).
...
requests](https://github.com/r4ds/ttmeta/issues) to make sure the bug
